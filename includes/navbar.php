    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            ...
            <div class="dropdown ms-lg-3">
                ...
                <button
                    class="btn btn-primary-custom dropdown-toggle"
                    data-bs-toggle="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                    ...
                    <?php if($_SESSION['role']=="admin"): ?>
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="<?= BASE_URL ?>/admin/registrations.php">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="<?= BASE_URL ?>/admin/points.php">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="<?= BASE_URL ?>/admin/gallery.php">
                    ...
                    <?php else: ?>
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="<?= BASE_URL ?>/member/dashboard.php">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="<?= BASE_URL ?>/member/profile.php">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="<?= BASE_URL ?>/member/idcard.php">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="<?= BASE_URL ?>/member/events.php">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="<?= BASE_URL ?>/member/leaderboard.php">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="<?= BASE_URL ?>/member/badges.php">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="<?= BASE_URL ?>/member/gallery.php">
